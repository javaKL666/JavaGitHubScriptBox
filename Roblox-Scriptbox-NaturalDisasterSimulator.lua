...
local Main = win:Tab("主要","7733765398") 
local Telephone = win:Tab("传送","7733765398")
local Disaster =win:Tab("灾难","7733765398")
local SuperRing = win:Tab("黑洞","7733765398")
...
print("服务器名称: " ..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)
...
local about = Main:section("功能",true) 
...
local about = Telephone:section("传送", true) 
...
local about = Disaster:section("灾难", true) 
...
local about = SuperRing:section("黑洞", true) 
